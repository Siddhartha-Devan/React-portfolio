  ...
  return (
    <section className='pf__projects' id='projects'>
      ...
      <div className='pf__projects-row-2'>
        <Procontainer title='Deepfakes Video Classification' desc = 'A Video Classification model was trained on 300 videos to classify original
and deep fake videos. The faces in the videos were cut out by using
mediapipe and 3d convolution layers were used to extract the temporal
